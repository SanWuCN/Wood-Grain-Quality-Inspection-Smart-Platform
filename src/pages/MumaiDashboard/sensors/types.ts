...
export type SensorFrame = {
  ...
  rawQuaternion?: Quat | null; poseEpoch?: string;
...
export type BridgeStatus = { state: 'idle' | 'connecting' | 'online' | 'reconnecting' | 'error'; message: string; deviceId?: string; batchId?: string; sessionId?: string; warnings?: string[]; profiles?: Record<string,{config:string;period:string}>; connection?: { actual?: {intervalMs:number;latency:number;supervisionTimeoutMs:number} }; disconnectCount?: number; uploadState?: string };
